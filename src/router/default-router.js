...
import Coustomer from '../views/pages/customer'
import Advertisement from '../views/pages/advertisement'
import TrackOrder from '../views/pages/trackOrder'
import Revenue from '../views/pages/revenue'
import Category from '../views/pages/category'
import ProductType from '../views/pages/ProductType'
import Product from '../views/pages/product'
import FabricType from '../views/pages/fabricType';
import NeckDesign from '../views/pages/neckDesign';
import SleevePattern from '../views/pages/sleevePattern';
import Occasion from '../views/pages/occasion';
import SubCategory from '../views/pages/subCategory';
import Size from '../views/pages/size';
import Ratting from '../views/pages/ratting';
import Brand from '../views/pages/brand';
import PostalService from '../views/pages/postalService';
import Tax from '../views/pages/tax';
import DeliveryCharge from '../views/pages/deliverCharge';
...
export const DefaultRouter = [
    {
        ...
        children: [
            ...
            {
                path: 'master/fabricType',
                element: <FabricType />

            },
            {
                path: 'master/sleevePattern',
                element: <SleevePattern />

            },
            {
                path: 'master/neckDesign',
                element: <NeckDesign />

            },
            {
                path: 'master/occasion',
                element: <Occasion />
            ...
            {
                path: 'master/postService',
                element: <PostalService />
            },
            {
                path: 'master/tax',
                element: <Tax />
