...
import JJIcon from '../../../../assets/images/icons/jkLOGO3x.jpg'
import LeftArrow from '../../../../assets/images/icons/left_aroow_side.png'
import RightArrow from '../../../../assets/images/icons/right_errow_side.png'
...
const Sidebar = memo((props) => {
    ...
    const [sideBarICon,setSideBarICon,sideBarIConRef] = useState(false)
  
    const minisidebar = () => {
      document.getElementsByTagName("ASIDE")[0].classList.toggle("sidebar-mini");
      setSideBarICon(!sideBarIConRef.current)
    };
    useEffect(() => {
      ...
      >
        <div className="sidebar-header d-flex align-items-center justify-content-start">
          <Link  className="navbar-brand">
            {/* <Logo /> */}
            <img src={JJIcon} style={{height:"30px"}}/>
          ...
          <div
            ...
            onClick={minisidebar}
          >
            <img src={sideBarICon?RightArrow:LeftArrow} style={{height:"25px"}}/>
            {/* <i className="icon">
              <svg
                width="20"
                className="icon-20"
        ...
        >
          ...
          <div className="sidebar-list navbar-collapse mb-3" id="sidebar">
            <VerticalNav />
          </div>
        </div>
