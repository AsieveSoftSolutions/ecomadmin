...
import Profile from '../../../../assets/images/icons/profileLogo.png'
// logo
        ...
        <Fragment>
            <Navbar expand="lg" variant="light" className={`nav iq-navbar ${headerNavbar} ${navbarHide.join(" ")}`}>
                <Container fluid className="navbar-inner">
                    <div className='w-100 d-flex justify-content-end gap-3 p-2'>
                        <img src={Notification} style={{height:"30px",cursor:'pointer'}}></img>
                        <img src={Profile} style={{height:"30px",cursor:'pointer'}}></img>
                    </div>
